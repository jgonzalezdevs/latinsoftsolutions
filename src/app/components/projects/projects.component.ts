...
export class ProjectsComponent implements AfterViewInit {
  ...
  projects: Project[] = [
    { id: 'xpinnit', key: 'xpinnit', tech: ['Angular', 'TypeScript', 'Node.js', 'PostgreSQL'], emoji: '🎯', gradient: 'linear-gradient(135deg, #f5f5f5 0%, #e5e5e5 100%)', cover: 'assets/images/projects/xpinnit-1-login.png', images: ['assets/images/projects/xpinnit-1-login.png', 'assets/images/projects/xpinnit-2-tablero-eventos.png', 'assets/images/projects/xpinnit-3-invitaciones.png', 'assets/images/projects/xpinnit-4-lista-tareas.png', 'assets/images/projects/xpinnit-5-detalle-tarea.png', 'assets/images/projects/xpinnit-6-exportar.png'] },
    { id: 'la-agencia', key: 'laAgencia', tech: ['Angular', 'TypeScript', 'Tailwind', 'Node.js'], emoji: '✈️', gradient: 'linear-gradient(135deg, #e5e5e5 0%, #d4d4d4 100%)', cover: 'assets/images/projects/la-agencia-1-login.png', images: ['assets/images/projects/la-agencia-1-login.png', 'assets/images/projects/la-agencia-2-inicio.jpeg', 'assets/images/projects/la-agencia-3-dashboard.jpeg', 'assets/images/projects/la-agencia-4-ventas.png', 'assets/images/projects/la-agencia-5-calendario.png', 'assets/images/projects/la-agencia-6-reportes.jpeg'] },
